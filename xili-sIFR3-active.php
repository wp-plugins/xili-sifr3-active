...
# Version date 090210 - 101203 - 120122 - 120525 MS

/*multilingue for admin pages and menu*/


define('XILISIFR3ACTIVE_VER','0.9.6'); /* used in admin UI*/
	...
	/* js files in header */
		if (is_sifr3()) {
			...
			if (file_exists(SIFR3INCURTHEMEPATH.'/'.SIFR3SUBJSFOLDER.'/sifr-config.js')) {
				echo "<script type=\"text/javascript\">var themefolder = '".str_replace(get_bloginfo('url').'/','',SIFR3INCURTHEMEURL)."';</script>\n";
...
<div class='wrap'>
		...
		<p>© <a href="http://dev.xiligroup.com" target="_blank" title="<?php _e('Author'); ?>" >dev.xiligroup.com</a>™ - msc - 2009-2013 - v. <?php echo XILISIFR3ACTIVE_VER; ?></p>
		<?php 
		}
?>